...
1. worker#408 → web-client#58 (small, both specified) so browser detection works; then tell Frances that Mindy can just open it.
2. Clear the portal backlog: bump #312 to 1.13.1 and merge, merge #317, close #314.
3. Back to the 2026-09-02 lane plan: G0 #153 contract still undelivered (`$CLAUDE_JOB_DIR/tmp/lanes/G0-153-contract.md`, three decisions awaiting Seth), then G1a/PB1.
