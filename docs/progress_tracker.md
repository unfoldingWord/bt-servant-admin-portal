...
| #230 resource visibility panel                          | 95%      | Read-only panel + per-resource server badges + taxonomy grouping all shipped in PR #265 (the "remaining display items" line this row used to carry was stale — they were already in). Visual map #261/PR #268. Attribution follow-up shipped 2026-08-11 (PR #289): one shared server-name join across list/map/panel, display hardening, emission bytes frozen.Remaining: per-server tool-call listings only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| #277 per-mode resource prioritization                   | 100%     | **Closed 2026-09-16.** Portal PR #282 (merged 2026-08-11, in prod since v1.12.0) + worker#366 (prod v2.50.0, 2026-09-09). Elsy confirmed the block in the preview doc 09-04. The adherence check is left to observation in use; reopen if the ranking shows no effect in prod.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| #286 org default language (worker#236 contract)         | 90%      | **PR #288 merged 2026-08-11** — BFF pair + Languages-page Default control (7-state machine, in-dialog 409 recovery, org-pinned mutations), contract-first: UI feature-detects and hides until Ian ships the worker route. Closed #272 as ride-along. Remaining: worker#236 implementation lands → end-to-end staging verify                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| #281 outside-priority disclosure                        | 90%      | **PR #290 merged 2026-08-11** — disclosure paragraph rides the #277 generated block (no ranking → no directive; old blocks upgrade on an offered, never silent, Apply). Issue open for Elsy's chat-side verification; pairs naturally with #277's accuracy check                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| #232 mode rename/reslug                                 | 100%     | Closed 2026-07-09: rename shipped 2026-06-26 (PR #238, v1.10.0), #240 rights-migration opened it to shepherds (PR #250), Elsy verified 07-07. Visibility follow-up (Elsy's option-4 pick) spun into #260.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| #247 admin bootstrap carve-out                          | 100%     | Shipped 2026-07-13 (PR #256 = `d4a6c56`, v1.10.4); Elsy verified same day; issue closed 2026-07-21. Deferred design half continues in #249.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| #254 Baruch Sonnet → Opus                               | 98%      | Eval **ran 2026-08-05**: functional tie at ceiling — 64/64 both models (raw 62/64 for Opus was one regex false-negative, corrected via transcript review). Opus ≈2.3× measured cost for qualitatively richer output. Evidence on baruch PR #20; Ian re-review requested. Switch is now a judgment call, not a data gap.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| #260 slug visibility + label sync (option 4)            | 100%     | Shipped 2026-07-21 (PR #262 = `b33e803`, same-day file→ship). Dropdown slug subtitle + header slug line + post-rename display-name prompt. **Closed 2026-08-05** — Elsy verified all three scenarios on staging; the #232→#260 arc is done.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| #209 requires_group toggle                              | 100%     | Shipped 2026-07-31 (PR #267 = `e7e095f`). Toggle + export round-trip, ModeFlags response-echo reconciliation, BFF edit-verb gate for the flag (review catch), worker#270 dependency verified shipped. +26 tests.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| #261 MCP server topology map                            | 100%     | Shipped 2026-07-31 (PR #268 = `379509b`). Pure-SVG org→servers→subjects map over the #230 data, honest degraded states, geometry-derived truncation, full sr-only a11y tree. +23 tests.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| #311 QR per mode + first-contact welcome                | 100%     | **Closed 2026-09-16** on Elsy's verification (QR 09-09, welcome 09-15). Portal PRs #316/#325 (v1.14.x) + #327 (v1.15.0), worker #423 (v2.52.0, in prod since 09-11). Sending the QR image on first contact moved to **#333** (needs gateway media sends). Hardening: worker#422, gateway#45. Portal side reaches prod with the next promotion.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| #328 edit mode description + welcome in-portal          | 100%     | **Shipped to staging 2026-09-16** (PR #335 = `ff63f43`, v1.16.0). Details sheet in the mode editor; shared `TextareaField` with the create card. Same PR closed a BFF verb-diff hole: `welcome_message`, `overrides` and `aliases` were unmodelled, so a publish-only shepherd could change them. 3 code-review rounds. Follow-up: #337 (low).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| #330 CI runs for stacked PRs                            | 100%     | **Merged 2026-09-16** (PR #334 = `2bd98f8`). uW standard trigger shape: unfiltered `pull_request` + `push: main`; PR runs supersede each other, each `main` commit gets its own concurrency group. An `edited` trigger was tried and removed (it cancelled real runs on description edits). Same bug filed on web-client as #66.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| #278 MCP global pool — worker side                      | 95%      | Shipped 2026-09-02 (worker PR #386 = `4fe714b`, v2.43.0) — `__global__` key, legacy fallback, hasAuthToken redaction; 7 rounds. M2 portal copy shipped (PR #320, v1.13.2). **Migration done in both envs:** prod `__global__` written by Ian 2026-09-09 ~12:42Z as a byte-identical copy of raw legacy `unfoldingWord` (3 servers), verified `server_count: 3`, 0 errors; staging `__global__` = the real 6-server pool as of 2026-09-11 (restored from legacy after the 09-10 `[]` seed blanked chat — worker#432). Remaining: Ian deletes prod legacy keys ~2026-09-16 (his lane; asked on 09-16 for a one-line confirmation when done). Prod `wordcollective` is byte-identical to the `unfoldingWord` fia entry, so deleting it loses nothing. Staging `wordcollective` holds a distinct staging-FIA entry; record its URL and token location before staging legacy keys go (after #292 verify). Chat-path warning for the 09-10 failure shape is worker PR #435 (v2.55.1, open for Ian). |
| #292 MCP server management UI                           | 90%      | **Shipped to staging 2026-09-09 (portal PR #323 = `40cb9bc`, v1.14.0).** `/mcp-servers` admin page + Resources link; owner-scoped edit, super-only delete; BFF-enforced. Backed by **worker#417** (ownerOrg attribution, PR #420, v2.51.0). 6 code-review rounds. Delete-authz confirmed 2026-09-10. Staging `__global__` gate cleared 2026-09-11 (real 6-server pool, not `[]`). Remaining: Elsy end-to-end verify against the real pool (5-step checklist posted 2026-09-16); portal prod promotion.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
- [x] #91 — Bump JavaScript actions to Node 24-compatible majors — closed 2026-05-13 (PR #131); the checkbox here was stale. Last holdout (`gitleaks-action@v2` behind a force-flag) closed out 2026-08-11 via PR #287 (`actions/checkout@v4` etc.) before GitHub's Jun 2 2026 forced opt-out / Sep 16 2026 hard removal. Filed 2026-05-08 after the deprecation annotation surfaced on the first staging-on-merge run.
...
**Merged (Seth's word each time):** #331 (09-11 EOD docs) → `3e88a03`; **#334** (#330) → `2bd98f8`; **#335** (#328) → `ff63f43`. Both feature merges deployed to staging; staging portal is **v1.16.0**.

**#328 — edit an existing mode's description and welcome (PR #335, v1.15.0 → v1.16.0).**

- Research showed it was portal-only: the worker's update route is its create route and already accepts both fields, with omit-keeps / `''`-clears semantics (`null` clears the welcome but is a no-op for the description). Scope posted on the issue before building.
- **Details** button in the mode editor opens a sheet with both fields, a read-only state without edit rights, and a WhatsApp-style preview of the welcome. Saves through the page's shared mode PUT with `seed: true`, so the next autosave doesn't revert the new values.
- **BFF authorization fix in the same PR.** The verb-diff gate modelled neither `welcome_message` nor `overrides`/`aliases`. A publish-only shepherd could therefore change the welcome, replace a mode's prompt content (the engine's `mergeContentFields` drops the stored document when `overrides` is present), or wipe its aliases. The welcome now counts as an edit when changed. `overrides`/`aliases` require edit rights on mere presence, since the portal never sends them on this route. Tests fail against the old gate.
- Review cycle: three `code-review` rounds. The second round of review cleanup extracted `lib/mode-copy` (shared denial strings), `components/textarea-field` (now used by the create card too) and a tested `describeModeDetailsSaveBlock`; it also fixed a misleading Details tooltip. The last round found only #337 (low): a Details save re-sends an already-rejected document.
- **Not verified:** a visual pass in a real browser. Dev/staging is the place to check it.

**#330 — stacked PRs got no CI (PR #334).** Took three review rounds to get right:

1. `branches: ["**"]` on both events. It worked, but doubled every feature-branch run and posted two differently-scoped `Secret Scan` checks.
2. The uW standard shape plus a guarded `edited` trigger for base retargets. Review showed a run is created before job `if:`s are evaluated, so a routine description edit cancelled the real run through `concurrency` and posted `skipped` checks over the verdict. Visible on the PR as runs `35114806794`/`35114806953`.
3. Final: unfiltered `pull_request`, `push: main`, no `edited`. PR runs supersede each other. `main` runs are grouped per commit, because a shared group cancels a _pending_ run when a third queues, and `deploy-staging` isn't gated on CI (real merge bursts on 08-11 and 08-19).

After a retarget, push or close/reopen; `gh run rerun` re-tests the old merge commit. This EOD branch is deliberately slash-named to exercise the fix. **web-client#66** filed for the same bug there. tc-mobile's `develop` already uses the right pattern; the copy the reviewer flagged was a stale local branch in `/workspace/tc-mobile-mockups`.

**Closed / filed.**

- **#311 closed** on Elsy's verification; scope boxes ticked. QR image on first contact → **#333**. Corrected my own closing comment: the worker half has been in prod since 09-11 (v2.54.0), only the portal is behind.
- **#277 closed** (live in prod since 09-09).
- **#337** filed (the #335 low finding, assigned).

**Prod path, careful nudges.**

- **#292:** asked Elsy for the end-to-end pass with a five-step checklist and listed everything a v1.12.0 → v1.16.0 promotion would carry.
- **#278:** told Ian that deleting prod `wordcollective` loses nothing. I owned that my 09-11 re-raise of the question was noise, since his 09-09 key list had already answered it. Asked him to record the distinct staging-FIA entry before staging legacy keys go, and for a one-liner when prod deletion is done.

**worker#432 — built item 1 (worker PR #435, v2.55.1, CI green, deployed to staging by the worker's PR workflow).**

- On the chat path, an empty `__global__` now triggers a once-per-isolate read of the legacy DEFAULT_ORG key. If it still holds servers, the worker logs `mcp_global_pool_empty_over_legacy` with `legacy_server_count`. Log only, nothing served changes, and it stops firing once the legacy keys are gone.
- Uses its own latch (the existing one is cleared on every successful `__global__` read).
- 8 unit tests, 4 of which fail against the old code. Full suite 1595/1595.
- Item 2 (409 on `PUT []` over live legacy data) deliberately not built: it reverses a tested contract and could block #292's remove-all flow. Waiting on Ian.
- Ian merges if he likes it; worker CLAUDE.md requires a human-triggered Codex review first.

**Assigned to me today:** #330, #328, #337, worker#432.

**Process notes.**

- A review subagent staged the whole #328 branch into the #330 worktree's index mid-session. Both branches were committed and pushed, so a hard reset of that worktree recovered it cleanly. Worth watching.
- The worktree guard rejects compound shell commands; one plain command per call and `--body-file` for any dynamic text. Saved to memory.
- Two review runs died on usage limits and were re-run after the reset.

**Next:**

1. Elsy's #292 verify → scope the portal prod promotion (v1.12.0 → v1.16.0).
2. Ian: prod legacy-key deletion confirmation on #278; decision on worker PR #435 and on #432 item 2.
3. #337 (small).
4. Visual check of the Details sheet on staging.
...
**Root cause — the 09-10 staging seed.** On 2026-09-10 the staging `MCP_SERVERS` `__global__` key was seeded with `[]` (intent: let #292's UI populate it as its own add-server test). The worker chat path (`readAllOrgKV` → `readMcpServerPoolOrEmpty` → `readMcpServerPool(source='chat')`, worker `src/index.ts:2133`) serves **only** `__global__`, and per its own docstring "`[]` under `__global__` is a real, empty pool and **disables the fallback**." That branch emits no log, so chat silently served zero MCP servers from the moment of the seed. The code's own operator guidance (case 2 in `describeLeftoverLegacyKeys` / the 409 body) already says to seed `[]` only when the namespace has no keys at all and otherwise migrate the raw legacy value — but it surfaces only on admin reads, not on the chat path that broke.

**Confirmed by three independent sources:**

- Code semantics (above).
- Staging Workers Observability logs: `mcp_global_key_missing` ×3 on 2026-09-09 (15:40Z, 15:44Z, 16:42Z), each `fallback_found: true`, `fallback_key: unfoldingWord`, `server_count: 6` — chat healthy via the legacy fallback — then **silence** after the seed (the empty-pool path is silent, not healthy).
- Direct staging KV reads (`76b75c54…`): `__global__` = **0 entries**; legacy `unfoldingWord` = **6 servers** (translation-helps, fia, aquifer, ptxprint-mcp, yaapi-bible, obs-5m); `wordcollective` = 1 staging FIA, which the DEFAULT_ORG-only fallback never read (orphaned legacy, not part of the regression).

Ruled out: the #366/#415 resource-priority directive — it is in prod too (v2.50.0), and prod was unaffected; the staging-only symptom pointed straight at the pool.

**Fix.** `__global__` restored from the raw legacy `unfoldingWord` value — the case-2 runbook path. Division of labor kept deliberate: Claude staged the value, pre-checked (re-read `__global__` still empty; validated 6 entries / ids / required fields / no `ownerOrg`), and read back; **Seth ran the `wrangler kv key put --remote` himself** (Claude's shared-KV write was blocked by the auto-mode classifier — shared-KV writes stay manual). Read-back: 6 servers in order, all enabled, FIA `authToken` preserved; legacy keys left untouched as rollback. **Elsy confirmed on Zulip: "Staging is back on track."**

**Prod.** Ian had already migrated prod `__global__` on 2026-09-09 the correct way — byte-identical copy of raw legacy `unfoldingWord` (3 servers), read back and compared before deploy, `server_count: 3` across sync/SSE/WhatsApp turns, 0 `mcp_global_key_missing` (his comments on #278). Prod was never touched today and won't be — standing rule recorded: **bots never touch prod.** Ian deletes prod legacy keys ~2026-09-16.

**Filed / posted:**

- **worker#432** (bug, Priority/Medium, Admin) — incident record + hardening: (1) chat-path once-per-isolate warn when serving an empty `__global__` while the legacy DEFAULT_ORG key is non-empty; (2) 409 on `PUT []` over live legacy data; (3) runbook rule on #278. Close-the-loop comment with Elsy's confirmation + Ian's prod note.
- Cross-link comment on **#292**: the staging pool is real now; add/edit/delete can be exercised against real entries (all six project as `ownerOrg: unfoldingWord`); only gate left for #292 → prod is the portal promotion.
- Milestone rows corrected above (#278 → 95%, #292 remaining trimmed).

**Access stood up this session:** in-container `op` via a service account; new 1P item `cf seths dev1` = CF account API token with **Workers KV read + write** (the `cf-workers-observability` token is logs-only — verified no KV scope). Memory notes corrected (the 09-10 "seeding `[]` is correct" conclusion was the miss).

**Also:** worker `main` pulled to `3311e89` (Ian's #424/#426/#428 Signal voice fixes overnight); Ian moving Jeremy's posthog work to prod today (keys/flags — unrelated to the MCP pool).

**Lesson:** never seed `__global__` with `[]` on an env whose legacy DEFAULT_ORG key has servers — it blanks live chat silently. Migrate the raw legacy value.
...
**The ask.** Frances Pacione forwarded a contact-form request from Mindy Lamb (Faith Comes By Hearing), training teams in Brazil to start OBT projects **this week**: could the interface be Portuguese? The model already replies in Portuguese; the chrome around it was English. Seth took it (native BR-PT speaker), Elsy agreed.

**Scoped from evidence, not assumption.** Two parallel repo surveys found: web client had **zero** localization (~45 hardcoded strings, `lang="en"`, no i18n library, no `Intl`, and **no UI test harness at all** — 4 tests, all on org resolution); the worker streamed ~9 English status strings into the chat, one of which (the max-iterations notice) is persisted to history and read aloud by TTS; the gateways have no user-facing strings. `response_language` existed end-to-end but nothing in the client ever set it. Existing issue #46 already named the two strings a user notices first.

**Design decision, reversed mid-flight and better for it.** First call was auto-follow (chrome follows the language you type in). During review that proved to be the complex path — detection edge cases, mid-conversation flips — and Seth switched to an **explicit user pick**, seeded from the browser on first visit and persisted. That deleted the hysteresis machinery, a client allow-list and a storage key from worker #404, and folded #52 into #51. Worker detection was kept as **telemetry only**, which also closes the worker#353 gap where roughly half of identifiable WhatsApp users were logged as English regardless of what they wrote.

**Shipped (5 PRs, all merged, all through the codex+grok loop):**

| PR             | What                                                                                                                   | Version |
| -------------- | ---------------------------------------------------------------------------------------------------------------------- | ------- |
| web-client #55 | jsdom + Testing Library harness and baseline UI/runtime/BFF tests                                                      | v1.8.2  |
| web-client #56 | Typed en/pt-BR dictionaries, locale registry, `LocaleProvider`, every string extracted, ESLint literal guard           | v1.10.0 |
| web-client #57 | Language picker, persisted `response_language`, `response_language_hint` on every request, worker status-key heuristic | v1.11.0 |
| worker #407    | Localized status/notice strings by `response_language`; `key` added to SSE status events (additive)                    | v2.45.0 |
| worker #406    | Per-turn written-language detection (tinyld/light), `input_language` on `chat_turn` + `ChatResponse`                   | v2.46.0 |

Also merged: worker #387 (fast-uri override, v2.43.1) which cleared `main`'s red Security Audit.

**Tests: client 18 → 213, worker 1185 → ~1350.** The client had no interface test harness before today; PR #55 exists because a ~45-string extraction with `tsc` and ESLint as the only net was not defensible.

**Review loop earned its keep — seven rounds on the client picker alone.** Confirmed defects the loop caught and we fixed: a **P1 SSE race** (queued writer registered after an `await`, so a drain mid-read dropped every event and hung the client stream); a **P1 enqueue yield** between the busy check and `enqueueEntry`, which could strand a request on the broken alarm path; **two write-ordering races** in the picker (abort cannot recall a PUT the server already has → serialized write chain with generation coalescing); a **seed PUT still carrying the load's abort signal**; and **six rounds of detector hardening** before gibberish, out-of-set languages (Indonesian, Swahili, Yoruba) and CJK-padded keyboard mash stopped resolving to a confident wrong label instead of `und`.

**Two contributors' PRs merged into the same files mid-flight**, forcing four careful rebases: worker #402 (per-turn LLM telemetry, took v2.44.0) and web-client #54 (PostHog analytics, took v1.9.0), both by Jeremy Pagley. Both unioned with their behavior preserved — verified by an empty `git diff origin/main` on every file they own exclusively, and by diffing all three analytics event payloads. **One deliberate change to #54's code, which Jeremy should hear about:** it added a user-facing timeout string as an English literal in `use-chat-runtime.ts`, which would have shipped untranslated English into the pt-BR UI and broke #56's rule that the hook holds no copy (there is a test that scans it). Moved into the dictionaries as `error.timeout`, English value byte-identical, analytics untouched.

**Native-speaker review, in the loop.** Built a private artifact holding all 45 strings from both repos, English read-only beside editable Portuguese, saving only changed rows to the artifact database. Seth reviewed and returned two edits (`thread.welcome`, the max-iterations notice); both were applied to the branches and the worker's paragraph is now pinned in full in `ui-strings.test.ts` so the wording cannot drift. Artifact: https://claude.ai/code/artifact/34441e5e-8862-4442-9eb6-8c472dd08ca7

**Verified on staging by Seth** in a Portuguese Chrome: interface strings, composer, disclaimer, and replies that correctly draw on a Portuguese reference text rather than translating from English.

**One regression found in that verification, filed not fixed** — worker#408 + web-client#58. `GET /preferences` cannot express "no language chosen": the DO merges `DEFAULT_PREFERENCES` (`response_language: 'en'`), so every user reads back `en`, and #57's client treats that as an explicit choice and overrides the browser-derived locale. A pt-BR browser renders English at v1.11.0; v1.10.0 rendered Portuguese only because it never read preferences. **Not fixable client-side** — the contract cannot express the distinction. Fix (both issues carry tests and a migration note): worker adds `response_language_explicit`, set only by `handleUpdatePreferences` and **not** by the first-interaction flip, which pollutes the stored record with a defaulted `en`; `handleGetPreferences` returns the language only when explicit, else `null`. Then the client seeds from the browser on null. Worker v2.47.0, client v1.12.0. The picker itself works and persists, so the feature is usable meanwhile.

**Sidebar (late evening): audited every open ask, ours and theirs, and answered ours.**

_What we were waiting on._ Four unanswered asks to Ian, all nudged on GitHub tonight (Seth also DMed on Zulip): the **prod `wrangler kv key list`** he offered to run on 2026-09-01 (#278 — blocks the prod `__global__` migration, therefore any prod worker dispatch, therefore #292); the **pilot WhatsApp number** (#311 — asked three times, blocks the whole acceptance check); **Elsy's prod super-admin grant** (#309 — assigned to him, zero comments, 11 days, one `curl` only he can run); and **OBS server registration** (#264 — 25 days). #264 was deliberately _not_ nudged: it likely self-serves once #278's global pool and #292's UI land, and chasing him for it would waste his attention. Cross-repo ownership (D-003) is settled and needs nothing further from him.

_What was open on us — and one item that had been open for 78 days._ On **#170** Elsy asked on 2026-06-18 "can you take the rest of the issues in this epic and let me know if they are blocked" and it was never answered. Answered tonight with a real triage, and the finding is bigger than a dependency chart: four of five tasks are blocked on **#172**, whose storage decision was recorded as Ian's in May, **never posted to the issue**, and repeated verbatim as "no movement" in five successive tracker entries — and which, since Ian's 2026-09-01 handoff, is **ours, not his**. #172 also names the wrong namespace (language documents are in `PROMPT_OVERRIDES` at `{org}:languages`, not `ORG_CONFIG`; there is no `SYSTEM_CONFIG` binding), so the real choice is a reserved key in the existing surface versus a parallel one — corrected on the issue. Most importantly the **epic's premise is undercut by work that shipped after it**: the 2026-08-27 "one response tuner per language" policy in #310 (one org owns each language draft; variants are distinct languages, not child variants) removes the reason for two of #170's three layers, and #249 already solved most of the org-customisation need. Asked Elsy and Tim for a rescope decision rather than a dependency chart. Tim's own modes-cascade question in that epic is **106 days** open.

_Other answers posted rather than left hanging:_ **#277** — one narrow question to Elsy (did she click Apply?) plus the self-serve way to settle it from the persisted staging document, which would answer #281 and worker#366 at the same time. **#292** — scope written back (one design slice with #278's lane M2, two PRs; `hasAuthToken` redaction shipped in worker#386 was its real prerequisite) with the one genuinely product question left for Elsy: is this UI for uW admins only, or do partner admins get it. **#311** — made the two part-2 decisions myself instead of leaving them open: per-mode-per-user `mode_welcomed:<slug>` rather than reusing `first_interaction` (otherwise the QR's viral path silently skips the welcome), and text-only V1 (the user just scanned a QR; showing them another is not the useful reply). **#153** — nudged Elsy's approver rule and stated plainly that the contract is drafted and waiting on three decisions of Seth's.

_Zulip turned out to be searchable from the container_ via the API key in the `zulip` file-manager repo's env file, and it answered two things GitHub could not. **The WhatsApp number has been known since 2026-06-24** — Tim posted it in _84 BT Servant > Branding_ while checking that the QR codes pointed where expected, and nobody corrected it in that topic through 2026-08-13. Deliberately **not recorded in any GitHub comment or in this file**, since both repos are public; it is one search away in Zulip. An attempt to corroborate it against the marketing site's QR failed — `assets/images/qr-code.png` decodes to a `scanned.page` landing link, not a `wa.me` URL — so Tim's message is the single source and Ian's confirmation of staging-vs-prod values is still worth having, just not worth blocking on. Second find: **Jaap-Jan's Zulip MCP is live** (2026-09-02, _52 Innovation > Zulip via MCP_) at `https://zulipchat-mcp.door43.org/mcp` with OAuth, behind an IP allowlist, added via `claude mcp add --transport http --scope user` with `X-Zulip-Email` and `X-Zulip-Key` headers. Worth wiring up — it replaces tonight's hand-rolled API calls.

_Tomorrow's plan of attack_ is posted on web-client#53, ordered by what needs nobody.

**Learnings:**

- **The npm audit endpoint (`/-/npm/v1/security/audits/quick`) was degraded all evening** — 400s, 503s and multi-minute hangs. It failed CI on client `main` after the #57 merge with a misleading `400 Invalid package tree`, which **skipped the staging deploy** and left staging on v1.10.0 while we believed v1.11.0 was live. The lockfile was byte-identical to `main` and a local run reproduced a 503. Fix was `gh run rerun <id> --failed`. **Suspect that endpoint before suspecting the lockfile**, and check the version in the app footer before trusting what staging is running.
- **A version can be claimed out from under you.** Both worker PRs and both client PRs had to be re-versioned mid-flight because contributors' merges took the numbers first (2.44.0, 1.9.0). Check `main`'s version and existing tags immediately before merging, not when the branch was cut.
- `codex review` needs `-c sandbox_mode="danger-full-access"` in this container (bubblewrap cannot create user namespaces), and `--base <branch>` cannot be combined with a custom prompt argument. Recorded in memory.
- **Backticks in a `grok -p "$PROMPT"` string get shell-substituted.** Write the prompt to a file and pass `"$(cat file)"`.
- Rebasing a stack after a **squash** merge needs `git rebase --onto <new-base> <old-base-tip>`; a plain rebase replays the pre-squash commits.

**Open / needs attention:**

- **Portal PRs #312, #314, #317 still unmerged** — untouched for a second day. #317 subsumes #314 (its commit is an ancestor); **#312 still needs its patch bump** (it carries 1.12.0 against a `main` now on 1.13.0).
- Yesterday's external gates all still open: staging `__global__` MCP key write, Ian's prod KV list (#278), Elsy's approver rule (#153), `WHATSAPP_NUMBER` Actions variable (#311).
- Jeremy's web-client #54 timeout-string move should be mentioned to him directly.
- Production for both repos is a manual dispatch; nothing has been promoted.

**Next** (full ordering posted on web-client#53):
...
### 2026-09-02 — Ultracode lane day: #308, #311 part 1, worker #278 all shipped and merged; 27-lane plan built; design skills published; fast-uri audit fix pending merge

**SOD:** portal + worker current; tc-mobile fast-forwarded 11. No overnight replies on the two gating questions (Ian's prod KV list on #278, Elsy's approver rule on #153) — still none at EOD.

**Lane plan (replaces the un-persisted 2026-09-01 sketch).** 14-agent workflow: 6 scopers → 3 drafts (critical-path / risk / value) → judge → 3 adversarial critics (28 findings, 2 P1) → final. Output `temp/lane-plan-2026-09-02.md`: **27 lanes**, critical path **G0 → G1a → G2 → G3 → PB4** (worker governance store chain). Load-bearing corrections: the dominant worker contention is the **version bump** (`pnpm version` regenerates `src/generated/version.ts` every PR), not `index.ts`; portal governance (PB1) builds in parallel but **merges only after the G1a PR is open**; G1a's first commit must move config helpers out of `index.ts` or `no-circular` trips; worker staging **redeploys on every PR push**; #365 create-only folds into G1a as a body flag (BFF strips headers). Seven lanes were startable with no external answer; three were run today.

**Completed:**

- **F2 — #308 shipped, PR #315 merged (`d01d2b4`, v1.12.1).** Pure `classifyModeImport` gate run at file-pick **and** confirm against the live list; create/import seed the list cache inside the awaited save `onSuccess` (TanStack awaits it before `isPending` drops); label-sync no longer clobbers a same-slug import; org now travels in mutation variables for all 7 save paths; the four P3s. Review: 4 codex+grok rounds + the `code-review` skill (10 findings, 2 confirmed new bugs — create seed cancelling the invalidate refetch; overwrite dialog dismissible mid-PUT — both fixed). 968 tests. Closed #308.
- **Q1 — #311 part 1 shipped, PR #316 merged (`3a1d144`, v1.13.0).** `src/lib/mode-share-link.ts` builds `https://wa.me/<digits>?text=%23<slug>`; SVG QR panel (`uqr@0.1.3`, canvas-free, we render the path) with copy / open / SVG+PNG download; eligibility state machine (published ∧ ¬requires_group ∧ gateway org; drafts "Publish to activate"; "number not configured"). `WHATSAPP_NUMBER` per-env var via read-only `GET /api/share-config` (`worker/share-config.ts`, not `worker/config.ts`); all three deploy workflows map it from an Actions variable. Review: 5 rounds — a **converging chain** (the deploy-var mapping was missing in PR → staging → prod workflows, one per round), round 5 clean at every severity. 985 tests. Rebased over #315: only the bump conflicted (→ 1.13.0 over 1.12.1); combined tree gated green (1016 tests). Deferred: post-create pointer (F2 region, now unblocked), worker first-contact message (Q2, contract posted on #311).
- **M1 — #278 worker side shipped, worker PR #386 merged (`4fe714b`, tagged v2.43.0).** 8 `MCP_SERVERS` touch points routed through `__global__`; `:org` echoed but ignored, `__global__` as org → 400; reads fall back to `unfoldingWord` while unmigrated; **writes 409 `MCP_POOL_NOT_MIGRATED` until the key exists** (API never creates it — runbook does); `hasAuthToken` redaction at all 5 response sites; write rule omitted→preserve / null→clear / string→set; operator diagnostics (`legacy_listing`, `stale_global_suspected`, three-case wrangler hint). Review: 7 rounds (grok 0C/2H/7M/5L in r1 → 0/0/0/5 in r7; codex clean 6 of 7). 1185 tests. The `qs` override bump (`>=6.16.0`) rode along, Seth-approved, re-reviewed. Portal copy sites (M2) and fan-out measurement remain.
- **uw-dev plugin v0.2.0** (uw-dev-skills PR #2 merged): `ux-then-ui` + `ui-craft` published from tc-mobile's gitignored copies so Jesse (`jag3773`, starting tc-mobile with Claude Code) gets them via the marketplace. `ui-craft` attribution generalized. Local plugin cache updated; tc-mobile local copies + gitignore entry still to remove (Seth's call — never committed anywhere else).
- **G0 — #153 governance contract drafted** (`$CLAUDE_JOB_DIR/tmp/lanes/G0-153-contract.md`, 13 items, every cite re-verified). **Not posted** — three decisions need Seth's eyes: 5-minute same-actor draft coalescing deletes the replaced revision (relaxes append-only); `FROZEN` = any plain PUT/DELETE on a `pending_review` head is 409; audit writes are best-effort and never fail the admin request.
- Status line reconfigured (model | branch | Ctx used/window (%) | 5h/7d rate limits, colored).

**In progress / pending merge:**

- **worker PR #387 — `fix(deps)` fast-uri override `>=3.1.6`, v2.43.1.** Main's CI on the #386 merge commit **failed Security Audit**: four high `fast-uri@3.1.5` advisories published 11:07 UTC, after #386's last PR CI and before its merge CI, so the staging deploy was skipped and **worker staging is still v2.42.0**. Fix PR: CI green (all 7), codex clean, grok approve / no medium+. Awaiting Seth's merge; then tag v2.43.1.
- PR #312 (#307 fix) and PR #314 (2026-09-01 EOD) still open awaiting Seth's merge; this entry is stacked on #314's branch.

**Learnings:**

- **The Security Audit gate is time-dependent.** Two fresh advisory sets (`qs`, `fast-uri`) landed mid-day and each broke a run that had been green hours earlier. Re-run PR CI immediately before merging, or merge promptly after green; expect an override-bump patch PR when it happens.
- `gh issue view --comments` prints **nothing** for an issue with zero comments; dump threads with `--json body,comments` instead.
- A rate-limit kill mid-review-loop was lossless because every reviewer wrote to disk before the agents died; resume by pointing the agent at the files.
- Auto-mode classifier blocked `gh pr merge` for the portal even after allowing it for uw-dev-skills; Seth ran the first merge via `!`, later merges went through. Consider a `Bash(gh pr merge *)` allow rule as tc-mobile already has.
- Review-fix handoff to Jesse was briefly proposed for these PRs and reverted the same hour (wrong chat); **self-fix codex+grok loop applies to all repos including tc-mobile** until Seth says otherwise.

**Blockers / needs Seth or others:**

- Staging `__global__` key write from Seth's host (`wrangler kv key get … unfoldingWord` → `put … __global__`, namespace `76b75c5465f0447995db8ec123056f22`) — until then staging MCP admin **writes** 409; reads fine. Prod: same, gated on Ian's key list, before any prod dispatch.
- `WHATSAPP_NUMBER` (E.164) as a portal Actions repository variable — gates #311's manual-scan AC.
- Elsy: approver rule for `pending_review → published` (gates only PB5 / the G2 guard).
- fix-215 worker worktree carries 7 uncommitted files — Seth's call before pruning the four merged worktrees.

**Next:**

1. Merge #387, tag v2.43.1, confirm worker staging deploys 2.43.x; write the staging `__global__` key.
2. Seth reads G0 → post to #153 with one-line cross-links (portal #154; worker #239/#94/#237/#365) → G1a (worker versioned store) and PB1 (portal foundation, contract-first) start per plan Batch 1.
3. Small lanes ready now: M2 (#278 portal copy, XS), F1a (#313 jsdom vitest project), R1a (#366 code-only diagnosis), Q1 follow-on (post-create QR pointer).

### 2026-09-01 — Assignment landscape shifted (Ian's two cross-repo handoffs); lane plan built; Batch 0 opened — worker synced + #307 shipped (PR #312)

**SOD:** clean tree, fast-forwarded 16 commits to `cce6931`. The morning's real news was in the issue threads, not the code: **two cross-repo handoffs from Ian plus a new business-critical assignment**, which reshaped the whole priority picture.

**Assignment landscape (all 2026-09-01):**

- **#278 (MCP global pool)** — Elsy **locked Option A** (shared `authToken` per server, no per-org creds, no org-level disable; stays purely additive) and confirmed sequencing **ahead of #277**. Ian then handed it to me **end-to-end incl. the worker side**: route all 5 `MCP_SERVERS` KV sites through a reserved global key, fold the **`hasAuthToken` redaction into this change** (GET returns raw configs incl. FIA's token — load-bearing prerequisite before #292), migrate the `unfoldingWord` key, rename `MAX_SERVERS_PER_ORG`, measure the `mcp_discovery` 0→6 fan-out, version bump. Open Q#6 (prod `wrangler kv key list`) — Ian offered to run it.
- **#153 (Governance & Versioning EPIC)** — Elsy **picked Option 2** (freeze-on-`pending_review`, gives revision history + rollback; shares C's storage foundation). Ian handed me **both repos**: versioned-config API (#154 / worker#239, worker#94) **+ audit log** (worker#237). D-003 (cross-repo PR authorship) already blessed. Worker versioned-config API is now the critical path for governance buckets B and C. Open (Elsy owns): who is the reviewer in `pending_review → published` (publish-holders vs separate role; self-approval vs four-eyes).
- **#311 (QR per mode)** — new, assigned today; Tim Jore flagged it "super critically important" (08-25 roadmap) as the viral-growth mechanism for the Colombia/Ecuador pilot. Portal QR-on-mode-creation is buildable; first-message send is worker/gateway.
- **worker#366** — formally assigned (resource-priority adherence = the real fix behind portal #277; portal side already verified correct).

**Lane plan (ultracode workflow: 6 parallel scopers over both repos → synthesis → adversarial critic).** 15 lanes; one true critical path = the **worker versioned-config store** (Option-2 makes buckets B and C share it): L0 sync → L1 contract → L4 create-only → L6 store → L11 state machine → L12/L13 UI. Dominant constraint is **file serialization, not logic**: worker `src/index.ts` (L2→L4→L6→L7/L11, each re-running `npm version` on the generated file), portal `languages.tsx`/`modes.tsx` (L5→L9→L14), portal BFF `worker/config.ts` (L10↔L12). Third repo in scope: **whatsapp-gateway** (L15). Review-loop naming confirmed with Seth: **frank = codex, george = grok**.

**Batch 0 executed:**

- **L0 — worker checkout synced** to origin/main `5f56b4a` (**v2.42.0**, was 43 commits behind at `d5bc2d2`/#191); removed 3 untracked `* 2.ts` duplicate cruft files. Every worker lane can now branch safely.
- **#307 (L5) — languages leave-and-return-during-save race — shipped as PR #312 (`60054ab`), CI green, pending merge.** The deferred systematic pass grok surfaced during #305. Fix avoids the reverted `b3b759d` false-positive class: bump `syncGenRef` **only** where the sync effect actually re-anchors locals (+ the create manual-install pin), capture it with each mutation's target, classify every settle site via `classifyMutationSettle → apply|skip|resync`. On `resync`, reconcile **synchronously in the settle callback** (not through the effect): the synced baseline always advances to what was saved (kills the doc/publish revert), draft reloaded only if untouched since re-anchor — a post-re-entry edit is kept and flushed (user-wins). Decision extracted to the pure, unit-tested `reconcileReanchor`. **codex + grok, 2 rounds**: round 1 found codex-P1 (post-re-entry edit loss) + grok-P2 (same-commit-autosave revert via the async `forceResync` bounce) + grok-P3 (create-path gen gap) — all fixed by the synchronous-reconcile pivot + create-install bump; round 2 clean of medium+. Typecheck/lint/**947 tests**/build green. Residual low P3 (no RTL lifecycle test) split to **#313**.

**Dedup reconciliation** (subagent research → 3 verdicts, all actioned): **#148 closed** as superseded-by-#311 (the QR welcome-screen ancestor; #233/#232 were mis-flagged — not QR). **worker#94 ↔ #154 = layered, kept both** (#154 = foundational versioned-config contract, #94 = revision-history/rollback on top; answered the stale 2026-05-27 question, marked #94 depends-on #154). **#310 ↔ worker#365 = distinct, kept separate** (#365 = same-slug create guard within one org; #310 = cross-org ownership — needs its own capability).

**Comms posted:** Ian on #278 (confirmed scope + take up the prod KV list), Elsy on #153 (reviewer-authz question).

**Operational notes:** the container has **no** Font Awesome Pro token (no `.npmrc`, no env var, not in any repo) — it exists only as the `FONTAWESOME_NPM_AUTH_TOKEN` GH Actions secret, injected into a throwaway `.npmrc` at CI time. A fresh worktree therefore can't `npm ci` or run the local green gate / husky until the token is written into a gitignored `.npmrc`; Seth provided it for local dev this session. **grok headless review invocation** (the elided half of the review-harness note): `grok -p "$PROMPT" --output-format plain --always-approve --allow read_file --allow grep --allow list_dir --cwd .` (plain `--prompt-file` without `-p` only streams TUI narration, no findings).

**Blockers / next:**

- **#312 (#307)** — awaiting Seth's explicit merge approval (CI green).
- **#153** — Elsy's reviewer-authz answer gates only the L11 transition guard; the rest builds to the interface. Next build (held per Seth): **L1 — write the versioned-config API + revision-shape + audit-log contract into the #153 epic as a design** before any PR.
- **#278** — Ian's prod KV list unblocks the migration scope; then L2 build (worker global-pool + `hasAuthToken`), sequenced ahead of #277.
- Next lane not started — Seth chose "hold / you decide" pending his direction (L1 contract vs L2 #278).
...
- **#264 — MCP-integration diff delivered and shared.** Read Benjamin's (deferredreward) live `5mobs-translation` mode off staging via the portal BFF (41,735 chars, published) and built a 2-column diff artifact against the obs-5m-mcp-integrated draft, in response to his 08-12 comment ("ingest the mode I've got on staging and tweak it to integrate the MCP server… present a 2-column diff"). **Core finding:** the current mode approximates the Five Movements questions from three general OBS tools (`fetch_obs_translation_questions/study_notes/study_questions`) and punts exact per-movement wording to **Scribe**; `obs-5m-mcp`'s `fetch_obs_study_manual` (part=intro/frames/community/movement1–5/drafting/checking/conclusion) supplies it verbatim in-chat — closing the gap Ben's own forward-compat note predicted. A faithful integration = Ben's guardrails (theological red lines, MT policy, risk radar, authority-pressure, data-source policy — 13 items) + the draft's tool layer, pacing, memory schema. **Fable red-teamed** the diff; 5 real contradictions/misreads fixed pre-share (self-contradicting `en_obs_tf` claim, `#34`-mooted-vs-hybrid, misread `id` path, unfair "data-source = one line", silently truncated "verbatim" quote). Seth shared the artifact on Zulip #84 BT Servant. **Two live checks gate the swap** (not yet run): (1) does obs-5m-mcp's `en_obs_tf` edition match what teams read in Scribe; (2) does `language=id` return structured questions or only a PDF. Plus decisions: tA/translation-notes hybrid, `1:0`=intro vs frame-0=title reconciliation, mode-switching.
- **Discovered worker v2.39.0 shipped overnight — #255 closed end-to-end.** Ian's worker#356 → PR #357 (tagged v2.39.0) landed the org-default rung of `resolveLanguageForTurn`, auto-closing worker#356 and portal#255. Staging live; prod pending Ian's manual dispatch. This gives our #288 org-default Languages control **real staging endpoints to verify against** (the end-to-end smoke was scoped but not run — auth path unresolved this session).
- **FIA reroute captured (worker#354).** Ian rechecked: we own the FIA server (`unfoldingWord/fia-mcp`), so its enumeration ask is a one-PR change to ourselves (**fia-mcp#3**) emitting the shape the existing translation-helps adapter already parses — no worker adapter change. A live staging read (every server's `allowedTools` is `null`) also kills the "silently filtered listing tool" hypothesis for #279's prod half.
- **Issue triage of 08-11's new filings.** #291 (tc-helps v2 OBS render regression) is Abel's lane — Elsy confirmed on Zulip he's on the v2 OBS bug; cross-link only, no portal work. #292 (MCP server management UI) intersects directly with #278 (global server pool); recommend designing them as one slice rather than bolting management UI onto the org-nested list.
- **Late written standup** posted + trimmed to Ian's terse register on Zulip.

**Operational note:** Reset Seth's staging portal password (lost-credential recovery) to regain BFF access for the mode read — PBKDF2 reproduced from `worker/crypto.ts`, written to `AUTH_KV_STAGING`, then rotated by Seth in-portal. No repo change.

**Blockers / next:**

- **#264:** run the two live obs-5m-mcp checks (`en_obs_tf`↔Scribe edition, `language=id` structured output) before assembling the integrated document for a practitioner trial. Awaiting Benjamin / practitioner feedback.
- **#288 / #255:** end-to-end staging smoke of the org-default pair (portal control ↔ worker v2.39.0) is now unblocked on the worker side; needs a staging auth path to drive the BFF.
- **#292 + #278:** propose combined design when picked up.

### 2026-08-11 — Ultracode day 3: worker#236 contract → four merged PRs same day

**Context entering the session:** SOD found PRs #282 (#277) and #283 (08-10 docs) open and green, and Tim's morning Zulip escalation (Spanish resource fallback, Bogotá deadline Monday) as the hottest team thread. Seth: merge both, then check Elsy's GitHub activity — then, on Ian's midday reply that the worker#236 storage shape was settled, "start and batch any other open work assigned to us or cleanly available."

**Completed:**

- **#282 + #283 merged** (Seth's word) — #277's ordering editor and the 08-10 docs entry landed on staging first thing.
- **#284/#285 (Elsy's re-files) cross-linked**, not re-investigated: both carry the 08-10 diagnosis — TC Helps has enumeration on both endpoints (worker#354 adapter gap, Ian's lane); FIA genuinely has none (upstream, correctly `unsupported`). #284's body is an FIA copy-paste under a tcHelps title; noted on the issue.
- **#286 filed and shipped same day (PR #288).** Ian's worker#236 comment settled the v1 org-default-language contract (rung 3; the #255 fix path); portal issue #286 captured his explicit portal checklist and the build ran contract-first — the worker route doesn't exist yet, so the UI feature-detects (upstream 404/501 → control hidden, quiet admin note). BFF pair with admin-only PUT (deliberately stricter than per-row verb rights — one org-wide pointer), 7-state UI machine (incl. `pending`, real `error`, and a `missing`-drift state with an unconditional Clear), in-dialog 409 recovery, role-aware copy, every language mutation org-pinned at mutate time. Closed **#272** as the ride-along (both files' stale #247 comments + the provably-dead collision branch). 814 tests (+111).
- **#230 follow-up shipped (PR #289).** The scout gate paid for itself: the tracker's "remaining scope" (server indicator + taxonomy grouping) had **already shipped in #265** — the real defect underneath was three surfaces doing server-name attribution three ways (list page showed machine ids where map/panel showed names). One shared join (`resource-servers.ts`), display hardening (control-char collapse, column-budgeted truncation, sr-only machine ids, collapsed `server.error`), and — after grok overturned the round-1 decision — **emission bytes frozen**: a v1.11.0-written priorities block regenerates byte-identically, machine-checked, so no surprise Apply enablement or document PUTs. 736 tests (+33).
- **#281 shipped (PR #290).** Elsy's disclosure proposal implemented through the #277 mechanism — the paragraph rides inside the generated Tool Guidance block (no ranking → no directive; zero worker changes). The hard part was CommonMark + back-compat: the review cycle caught the paragraph parsing as a _lazy continuation of the last list item_ (a global instruction read as a note on the lowest-ranked resource — meaning-inverting, pinned by a remark sibling-parse test), a **dual-confirmed P1** data-loss path in the orphan-repair blank-line lookahead (now crosses only the complete disclosure paragraph, byte-exact), and an Apply/autosave revert race (closed at two layers: `shouldAutoSaveDraft` pure predicate + ref guard — the agent correctly rejected my suggested third mechanism as decorative). Old blocks upgrade on an offered, never silent, Apply with an honest explainer (`isOfferedBlockRefresh`: corrupt/removal/normalization all excluded). 747 tests pre-merge; 891 on the merged tree.
- **#287 shipped** — scout found #91 was closed since May (stale tracker checkbox); the one real Node-20 holdout (`gitleaks-action@v2` + force-flag, whose "drop when v3 ships" note had been stale ~2.5 months) bumped to v3; the Secret Scan job proved it in situ.
- **Batch pipeline, by the numbers:** 4 implement lanes (isolated worktrees, Opus) → 3 adversarial verifiers → 3 codex+grok rounds + final delta pass → **codex clean + grok APPROVE on all three feature lanes**. ~20 confirmed findings fixed across rounds; the trend was healthy convergence (core defects → fix-edge defects → copy/predicate honesty). Review-cycle tables posted on each PR. All four **admin-merged in order** on Seth's word; #290 needed a merge-resolution commit (#289/#290 shared `resource-priority.ts`; one real conflict, test-file imports; both invariants verified on the merged tree).
- **Follow-ups filed with Seth's OK:** #293 (create-over-existing slug silently overwrites + unpublishes — surfaced twice in #288's review) and #294 (last raw untrusted MCP text family on the resources page + two cosmetic carry-overs).
- **Workspace cleaned:** 6 defunct worktrees removed, all merged local+remote branches deleted, remote refs pruned (~60 stale), review clones removed. Staging carries all four merges (final deploy green).

**Decisions (Seth):** merge #282/#283; batch scope = #286 + cleanly-available (#280 skipped as explicitly Ian's; gated items skipped); yes on follow-up issues; admin-merge all four in order; clean workspace + EOD.

**Blockers:**

- **#286 end-to-end** — worker#236 implementation (Ian's lane; contract settled, route not yet on worker `main`).
- **worker#354 / #278 / #255 / #279-prod-curl** — unchanged, Ian's lane.
- **Tim's translated-resource-fallback thread** — hot, Bogotá deadline Monday; worker-side; no portal ask yet. Watch for the team's design pick (Tim proposed warn-then-translate).

**Next Steps:**

- Elsy staging passes: #277 ranking panel + accuracy check, #281 disclosure-in-chat, #286 UI states (control correctly hidden until the worker route ships). Suggested combined test posted on #277/#281.
- Watch Ian: worker#236 implementation (flips #286 to verifiable), worker#354, #278 sign-off.
- Tim's CSB-preference ask is a natural first real use of #277's ordering once resources carry it.
- #293/#294 are sized for a future small lane.

### 2026-08-10 — Ultracode day 2: #277 design→PR same day; Elsy's threads cleared; #269/#279 root-caused live

**Context entering the session:** SOD found prod freshly promoted to v1.11.0 (the 08-05 dispatch completed that evening), PR #274 (docs) open and green, and new issue #277 carrying the 2026-08-06 meeting's locked design decisions. Seth's directive: surface what Elsy was asking about, then start an ultracode session on those issues.

**Completed:**

- **#255 answered** (Elsy asked same morning whether it was done): in progress, not completed — Ian's 07-30 design (org-default-language rung in `resolveLanguageForTurn`) is locked but implementation hasn't started; his declared start signal (storage shape on worker#236) hasn't fired. Portal specs the default-language toggle against that shape when it lands.
- **#277 shipped to PR #282 same-day.** Scouting workflow (4 agents over portal + current worker `main`) settled the load-bearing fork: the worker's `mergeExistingMode` field whitelist makes a structured `resourcePriority` field impossible today (worker#257 item 2 is one dead type stub), but the mode document flows into the `tool_guidance` prompt slot verbatim — so the ordering persists as a **generated, delimited markdown block spliced into `## Tool Guidance`** (the document is the storage AND the injection; precedent worker#306). Zero worker changes, no new PUT field, no BFF/authz/export changes. Build pipeline: 2 implement lanes → 2 adversarial lenses (**8 confirmed defects fixed**, incl. two document-corruption paths: orphaned-marker data loss; untrusted server labels smuggling the closing marker) → independent re-verify → 4 residual findings fixed by hand. External review: **3 rounds codex + grok**, every medium fixed same-round (greedy line-anchored order parse vs `]`-in-id false-corrupt; apply-error lifecycle incl. ownership-gating and draft-divergence retirement), round 3 = codex clean / grok APPROVE, their 3 remaining P3s applied verbatim. 703/703 tests (+65 new). CI green on all four pushes; per-PR worker deployed. **Awaiting Seth's merge word** (asked; he first confirmed the local review loop had run — it had).
- **#264 scoped + mode document drafted.** Live probe of `obs-5m-mcp.unfoldingword.workers.dev`: public streamable-HTTP MCP, 12 read-only tools, `fetch_obs_study_manual` with an 11-part enum matching the five-movements pacing; registration payload posted for Ian (`transport: "streamable-http"` required). Full seven-section mode document drafted **from the live server's own content** (every movement's questions verified by fetching them; unverifiable issue items — panel views, durations, master-copy holder — flagged honestly) and posted for Tim/Elsy. Open: canonical framing (5 movements vs 11-part sessionFlow — the draft reconciles them), mode slug, target org (#278 gates partners).
- **#274 amended + merged** (Seth's pick): the 08-05 entry now records the completed v1.11.0 promotion with an explicit amended-note; squash-merged, remote branch deleted. Docs-only → staging deploy correctly skipped (`paths-ignore`).
- **#278 scoped, comment posted.** Verified on worker `origin/main`: `MCP_SERVERS` KV keyed by raw org name, 5 read sites, chat-path fallback `[]` — so **partner orgs get zero MCP fan-out in chat**, not just an empty Resources page; the `ORG_ADMIN_KEYS` middleware branch is unreachable dead code (portal BFF is the only real gate). Options A–D with tradeoffs; recommendation **A** (single global "library" key; #277 owns the shelf-ordering) + guardrails (reserved-key collision guard, `authToken` redaction before any partner-facing UI, chat fan-out blast-radius measurement). Sequencing made explicit: **#278 gates #277 for partner orgs.** Worker-side, Ian's lane.
- **#269 + #279 root-caused; worker#354 filed.** Live probes: TC Helps staging (`/v2/mcp`, v2.0.0) exposes `list_resources`; TC Helps prod (`/api/mcp`, v7.5.0) exposes `list_resources_for_language` and returns the worker#257 fixture byte-for-byte — the contract was validated on prod while the bugs were reported on staging. `selectListingAdapter` exact-matches only two tool names, so staging TC Helps (and `yaapi.bible`'s `list_versions`) report `unsupported` despite being capable — **both issues' premises were wrong; no partner ask needed for TC Helps**. FIA is the one genuine no-enumeration server (correctly `unsupported`). worker#354 carries the full adapter spec (summary-line strip, `available[]` mapping, adapter ordering) + the allowedTools-masking observability caveat. One prod-side check left for Ian (one `?discover=true` curl).
- **Tooling correction captured:** codex's GitHub-MCP fallback in uw-sandbox now produces a low-confidence non-review (a dud that reads like a pass); working invocation is `-c sandbox_mode="danger-full-access"`, which reviews the local diff. Memory updated.

**Decisions (Seth, via multiple-choice):** #274 amend-then-merge (done); #254 stays in Ian's lane, no push either way; next queue = #278 scoping, #269/#279 diagnosis, tracker+EOD (all done); #282 merge posture — his question "did we run the local frank/george loop?" answered (yes, 3 rounds to convergence), merge word still pending.

**In Progress:**

- **PR #282** (#277) — open, CI-green, dual-approved, mergeable. Waiting on Seth's merge word (or Frank's GitHub pass first, his call).

**Blockers:**

- **#255 fix** — worker-side, Ian's queue (start signal: storage shape on worker#236).
- **worker#354 + #278** — both Ian's lane; #278 additionally needs Tim/Elsy sign-off on the global-library exception to per-org scoping.
- **#264** — framing pick (Tim/Elsy), slug pick, server registration + org question (Ian; #278 for partners).
- **#279 prod half** — one authenticated `?discover=true` curl (Ian).

**Next Steps:**

- Merge #282 on Seth's word → Elsy staging pass on the ranking panel → the #277 accuracy-check item (prompt-adherence assessment) becomes the issue's remaining scope.
- #264: finalize the mode document once Tim/Elsy pick the framing; create the mode via the portal once the server is registered.
- Watch for Ian on worker#354 (un-breaks staging Resources), #278 (unblocks partners end-to-end), worker#236 storage shape (portal's default-language toggle), and the #255 fix.

### 2026-08-05 — Prod promotion coordinated + cleared; #254 eval ran (tie at ceiling); #260 closed on Elsy's verification

**Context entering the session:** All of the 07-31 batch was merged and staging-deployed; the only open threads were Ian's-lane gates (#254 API key, worker#346, worker#257 item 2) and two pending Elsy staging passes (#249 checklist, #260). No code changes were planned or made today — this was a coordination, verification, and evidence day.

**Completed:**

- **Staging→prod promotion coordinated and fully cleared.** Ian asked in written standup for sign-off on pushing the BTS Admin portal + Baruch from staging to prod as part of his production SOE (telemetry bring-up). Seth + Elsy: no objection. Posted a three-caveat assessment (worker#270 sequencing for #209; the two never-run staging verifications; #249's deliberate no-creator-auto-grant delta). Ian's reply closed caveat 1 outright — **prod worker has carried worker#270's `requires_group` merge semantics since v2.27.0** (verified in the deployed 2.29.0 tag) — and confirmed the worker ships today (2.29.0 → 2.37.0, gated on a D1-telemetry regression check with documented rollback; the deploy also brings worker#257, un-degrading the Resources panel + topology map). Caveat 2 gave Ian pause; posted a decouple recommendation (worker + Baruch proceed; portal after a ~15-min Elsy pass, else ship-and-verify-on-prod or hold a day). **Elsy ran both passes the same afternoon**: #249 all four spec §5 scenarios PASS (including the no-auto-grant behavior delta confirmed as intended — the #247 scenario) and #260 all three scenarios PASS. **Worker prod deploy succeeded 17:03 UTC**; the portal Deploy Production dispatch was still pending at EOD with zero caveats remaining. _(Post-EOD outcome, amended 2026-08-10: Ian completed it that evening — version bump PR #275 → `v1.11.0`, Deploy Production run `31041497803` succeeded 19:53 UTC. Prod portal is at v1.11.0.)_
- **#260 closed** with a verification-summary comment referencing Elsy's pass at `b33e803`. The #232 → #260 mode-slug-visibility arc is fully shipped and verified.
- **#254 eval ran** the moment the key landed (`/workspace/baruch/.dev.vars`, gitignored). 36 real orchestrator-loop conversations (9 scenarios × 2 models × 2 runs), ~5 min wall clock. Raw scorecard: sonnet-4-6 **64/64**, opus-4-8 **62/64** — but transcript review before reporting showed the two Opus misses were **one heuristic false negative**: S8's `reports-not-found` regex (`not found|doesn't exist|no mode|…`) can't match "No \`mast-methodology\` mode exists" because the backticked name splits "no" and "mode". Functionally Opus handled S8 _better_ than required (did-you-mean + offer to create). **Corrected result: 64/64 both — a tie at ceiling.** Measured cost for the identical workload: Sonnet ~$0.40 vs Opus ~$0.92 (≈2.3×: the $3/$15 vs $5/$25 per-MTok multiplier compounded by 62% more output tokens and larger tokenized inputs under the Opus 4.7+ tokenizer). Qualitative: Opus's S6 narrative-mining proposals ~2× richer; Sonnet missed nothing Opus caught. Correction note appended to `comparison.md`; full evidence + honest interpretation posted on baruch PR #20 (no regression proven, no improvement proven — the switch rests on qualitative richness vs cost); Ian's review formally re-requested; cross-link status comment on #254. Per the pre-declared honesty rule, the tie is reported as a tie.

**Patterns / decisions captured:**

- **Verify heuristic-check failures against transcripts before reporting.** The eval's only apparent differentiator was a regex artifact; reading the two raw transcripts turned a "Sonnet wins 64–62" headline into the true "tie at ceiling." Keyword checks over model prose are evidence of _phrasing_, not behavior — treat any heuristic (H) failure as unverified until the transcript is read.
- **The decouple move resolved a hold-or-ship stall.** Ian paused the whole promotion on one portal caveat; splitting the decision (worker + Baruch unaffected → proceed; portal → cheap 15-min verification path with two explicit fallbacks) got the worker shipped and the portal cleared the same afternoon, instead of holding three deploys on one open question.

**Blockers:**

- **Portal prod dispatch** — cleared, awaiting Ian's workflow run (confirm version once it lands).
- **baruch PR #20** — awaiting Ian's re-review; merge/close is now a product judgment (qualitative edge vs ≈2.3× cost), not a data gap. Note Baruch went to prod today on current main (Sonnet default).
- **#230 ordering editor** — worker 2.37.0 brings #257, but whether item 2's ordering write-path is included is unconfirmed; check once the deploy soaks.
- **worker#346** (portal #195 lane) — no movement.

**Next Steps:**

- **#198 mode-config import** — the dev lane deferred today; unblocked by #209's export change. #272 (stale #247 comment refs) rides along.
- **Confirm the portal prod deploy** landed + note the version; verify worker 2.37.0 passed Ian's regression gate and whether worker#257 item 2 shipped (would unblock the #230 ordering editor).
- **Watch** baruch PR #20 for Ian's call, worker#346.

### 2026-07-31 — First ultracode batch: #209 + #261 + #249 shipped same-day (PRs #267/#268/#271); codex+grok dual review harness operational; #195 worker ask filed; #254 eval harness built

**Context entering the session:** Ian's 07-30 unblock batch stood; overnight the 07-30 EOD docs PR (#266) merged. Seth green-lit the first run of the **batch-pipeline skill** (`/workspace/temp/batch-pipeline` — lane briefs, premise checks, worktree isolation, implement → independent verify → dual external review → authorized merge), installed **codex + grok CLIs** as the two independent review harnesses (Reviewer A/B), approved #254 eval spend, and set the model policy: **Fable 5 orchestrates, Opus implements** (passed explicitly per the skill's inherited-model trap).

**Completed (all three merged, staging-deployed, CI green):**

- **#209 → PR #267 (`e7e095f`)** — "Requires group chat" toggle + export round-trip. The review loop hardened it substantially beyond the build lane: single `ModeFlags` value reconciled per-key from the PUT response echo (`??` not `||` — worker's `toMarkdownView` keeps `false`), tracker name-guard for mode-switch-during-save, synchronous in-flight save **count**, switch a11y (`title` + `aria-describedby`), and the round's big catch — **the BFF verb-rights gate was blind to `requires_group`** (flag-only PUT computed zero required verbs; a publish-only shepherd could flip group visibility via direct API). Fixed as edit-verb gating with `?? false` legacy coercion; negative control: reverting the gate line fails 6 tests. Worker dependency (worker#270) verified shipped, merge semantics confirmed at worker `src/index.ts:1365`. +26 tests.
- **#261 → PR #268 (`379509b`)** — MCP server topology map on the Resources page: pure-SVG org → amber trunk → server nodes → subject-count leaves over the exact PR #265 payload (no new endpoints, no diagram dependency); branch stroke encodes `ok`/`unsupported`/`error` honestly. Review rounds added geometry-_derived_ truncation budgets (org 17, caption 30 with a 9-char language sub-budget — free-text IETF input is user-controlled), full-string `<title>`s wherever truncation applies, an `aria-hidden` SVG + structured sr-only DOM equivalent (AT users get ≥ List-view information), and degraded-with-items caption honesty ("failed to respond — N resources shown"). +23 tests.
- **#249 → PR #271 (`991ea68`)** — the day's headline. Elsy +1'd option 4 mid-session → joint pick → **spec → adversarial spec verification (10 draft errors corrected against real code) → Opus implement → independent verify → dual review → merge, all same day**. One-line trump (`hasAdminPowers` now covers languages in `gateConfigMutation` check 2) plus **full deletion of the #247 bootstrap carve-out** (grant/compensate/`X-Bootstrap-Grant` language pipeline, rights-migration language helpers): −1157/+269. Org-wide draft visibility (client filter removed — worker GETs were already open, so zero security delta), read-only rows for non-granted shepherds, "Read-only" status text. The #247 deadlock is now a permanent regression test with KV-unchanged assertions. Both reviewers clean in a **single round** — the spec-first pipeline left nothing to find. Deliberate behavior delta flagged in PR: admin creates no longer write a creator auto-grant (demoted admins lose rights on drafts they created — exact mode parity). Elsy's 4-scenario staging checklist posted on the issue.
- **#195 premise-check → blocked correctly.** Worker exposes no read path for persisted session language (`getSelectedLanguage()` is a private DO helper; the classifier mutates language at chat time so it can't be derived portal-side). Instead of shipping the mode-only half, filed **bt-servant-worker#346** with the exact routes (mirror the `/mode` trio), response shape, and the scoped portal follow-up. Lane re-runs the day it merges.
- **#254 eval harness built + smoke-tested** (`$CLAUDE_JOB_DIR/tmp/eval-254/`): 9 scenarios / 32 checks over baruch's REAL `buildSystemPrompt`/`buildTools`/orchestrator loop with canned tool fixtures, pinned to the PR's exact pair (`claude-sonnet-4-6` vs `claude-opus-4-8`), 2 runs per scenario per model, raw transcripts for audit. Blocked solely on an API credential — Ian's working it; one command once it lands, then evidence → baruch PR #20 → re-review.
- **Hygiene:** #272 filed (stale #247 comment refs in `worker/auth.ts` + `language-selector.tsx`, ride-along). Workspace swept: 18 stale worktrees removed (one 2-month-old WIP archived to job tmp first), orphaned local branches deleted, main checkout fast-forwarded to `991ea68`.

**Patterns / decisions captured:**

- **The dual-harness asymmetry is the value, not redundancy.** Codex (diff-scoped, fast) posted clean 4×; grok's deep-tree pass caught the one genuine authz gap — in code the PR never touched, invisible to any diff-only review including the internal verifier. Two independent convergences (org-label overflow, caption overflow) were the highest-confidence findings of the day. Keep both lenses; never treat one as fallback for the other.
- **Grok headless invocation traps** (cost 4 dead runs): (1) default permission mode silently _cancels_ the session when the model reaches for a terminal command — grant `--allow read_file --allow grep --allow list_dir` and say terminal is forbidden; (2) large prompts get offloaded to a file the model must read back — never combine with "you have NO tools"; (3) a run that ends on narration ("I'll review…") is a cancelled/stalled run, not a clean one — demand the final message be the report. Codex traps: `--base` and a custom prompt are mutually exclusive (default instructions are fine); bwrap sandbox can't run in this container so codex reviews via its GitHub MCP connector — reviews the pushed PR diff, so push before invoking.
- **Spec-first beats fix-later, measurably.** #249 (spec adversarially verified pre-implementation) → zero review findings. #209/#261 (build-first) → 11 accepted findings across 5 rounds. The spec pass cost one agent; the review rounds cost ~6 agents + 2 fix lanes.
- **Frank did not fire on any of the three PRs** — ready→merge gaps of ~15s apparently skip the cloud connector entirely. Post-merge sweeps of all surfaces came back empty. If Frank's lens is wanted on batch PRs, hold the merge a few minutes after `gh pr ready`.
- **Premise-check ROI again:** #195's check (worker read-path missing) converted a would-be churned half-feature into a precise cross-repo ask, same pattern as the 07-30 #230 sequencing.

**Blockers:**

- **#254 run** → API credential (Ian, in motion).
- **#195** → worker#346 (filed today, Ian's queue).
- **#230 ordering editor** → worker#257 item 2 (Ian, after OTel prod push).
- **#255 portal surface** → Ian's org-default rung + worker#236 storage shape.
- **Elsy staging passes** → #249 checklist (posted today), #260 (pending since 07-21).

**Next Steps:**

- **Run the #254 eval the moment the key lands** (`ANTHROPIC_API_KEY=... npx tsx run-eval.ts`), attach evidence + methodology to baruch PR #20, request Ian's re-review. Honesty rule stands: ties or Sonnet-wins are valid outcomes.
- **#198 (mode-config import) is now unblocked** — it was deliberately sequenced behind #209's export change. Natural next dev lane.
- **Watch** worker#346 (unblocks #195 lane re-run), worker#257 item 2 (ordering editor), Elsy's verifications.
...
**Context entering the session:** tracker current through 07-13; Ian's blessing emails on the engine-repo housekeeping proposals had landed (#201 on 07-14, #202 later same day).

**Completed:**

- **Engine #201 + #202 closed as superseded** by portal #230 per Ian's blessings, with closeout comments crosslinking worker#257's `servers[]` status block. Scope-traceability note posted on #230 flagging the one uncovered slice (per-server tool-call listings). The visual-map ask refiled as portal **#261**, sequenced post-#230.
- **#255 root cause upgraded from inference to evidence** (Workers Observability, 7-day sweep): zero `language_not_found` warns on prod+staging (rules out the published-filter/masking path); only two turns in the window ever resolved a language, both portal test-chat (07-08 staging, doc injected); all 14 prod turns on Elsy's testing day carried `requested_language=null`. Confirms the web client sends no language context — the injection plumbing itself works when asked. Posted on #255 for Ian with a design note: the fix hook should anticipate worker#236 / portal#175 cascade resolution landing at the same point.
- **#232 audit surfaced a dropped promise**: Elsy picked option 4 for the slug/label visibility follow-up on 07-02 and asked for it to be filed; #241 had closed the day before and the filing never happened. Verified none of it shipped in code, then filed **#260**.
- **#260 implemented and merged same day — PR #262 (`b33e803`).** Dropdown items show a mono slug subtitle when a label masks the slug (hidden in the closed trigger via a `[[data-slot=select-value]_&]:hidden` ancestor variant — Radix mirrors ItemText children into the trigger); header strip shows the canonical slug before the `also:` alias badges; after renaming a labeled mode, an "Update the display name too?" dialog offers an editable humanized-slug suggestion (#102 inline-error contract). `slugify` extracted to `src/lib/mode-slug.ts` + `humanizeModeSlug`, 12 new unit tests (596 total). Review verified the two load-bearing claims against engine source: the `_rename` response always carries `document` (so the sync PUT can reuse it as server-truth body), and the engine upsert preserves `aliases` when the PUT omits them (no alias stranding). Approve, no medium+; staging deployed; **issue open for Elsy's staging pass** (walkthrough posted).
- **#247 closed** — Elsy's 07-13 verification of v1.10.4 was the only open gate.

**Blockers / waiting:** #254 (Ian: baruch PR #20), #249 (Elsy + Ian: design pick), #230 (Ian: worker#257 endpoint, untouched since 06-24), #260 + #261 downstream.

**Next steps:** pick up whichever unblocks first — Elsy's #260 verification (close on pass), Ian's #249 answer (implement the picked option), or worker#257 landing (#230 panel work). Also note: main gained `70cd353` (README sync) outside session tracking.
