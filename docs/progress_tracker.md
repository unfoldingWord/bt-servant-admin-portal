...
| #277 per-mode resource prioritization                   | 95%      | **PR #282 merged 2026-08-11**, staging-deployed. Ordering persists as a generated block in the mode doc's Tool Guidance (zero worker change). Same-day follow-ons on the mechanism: #281 disclosure line (PR #290), emission freeze (PR #289). Remaining: Elsy staging pass + the issue's prompt-adherence accuracy check                                                                                                                                                                                                                                                                                                                                                                                                |
