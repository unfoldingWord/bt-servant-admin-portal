...
4. **#155 optimistic concurrency** (portal-side wrap of #154's expected-version mechanism) and **#160 portal diff view + revision timeline** — both depend only on #154 and can ship as soon as it lands. State-aware timeline visualization in #160 is layered after #156.
5. **#156 revision states** + dependents (#159 draft test mode, #163 review notifications).
...
| 2026-05-29 (rev 7) | Frank P2 fix on rev 6. Phase 1 entry sequence had #160 listed as a dependent of #156 (step 5), contradicting the corrected dependency table where #160 depends only on #154. Moved #160 alongside #155 in step 4 (both unblocked as soon as #154 lands) and noted the state-aware-timeline visualization layer in #160 follows #156.                                                                                                                                                                                                                                                                                                                                               | Claude |
