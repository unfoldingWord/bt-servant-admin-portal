    ...
    <div className="bg-dot-grid relative flex min-h-full flex-col items-center justify-center p-8">
      ...
      <div className="relative flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          ...
          <span className="mt-2 inline-flex items-center rounded-full bg-amber-500/10 px-3 py-1 text-xs font-medium text-amber-600 ring-1 ring-amber-500/20 dark:bg-amber-400/15 dark:text-amber-400 dark:ring-amber-400/20">
            Coming Soon
          </span>
